...
D_UTILS		=	utils/ft_atoi.c			utils/ft_itoa.c		utils/ft_split.c		utils/ft_strcmp.c	utils/ft_strjoin.c	utils/ft_strncmp.c	utils/get_env.c		utils/is_heredoc.c	utils/get_path.c		utils/is_operator.c\
				utils/is_parent.c		utils/set_env.c		utils/ft_calloc.c		utils/ft_strchr.c	utils/ft_strdup.c	utils/ft_strlen.c	utils/ft_substr.c	utils/is_whitespace.c	utils/set_paths.c
...
D_MINISHELL	=	main.c		pipe_check.c		tools.c
